...
function displayhelp {
  ...
  echo "--ipconfig will display ip info"
  echo "--os will display operating system info"
  echo "--cpu will display cpu info"
  echo "--memory will display memory info"
  echo "--disk will display disk info"
  echo "--printer will display printer info"
}
