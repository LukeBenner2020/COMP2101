...
function get-cpuinfo {
    get-ciminstance -Class 'cim_processor' | format-list Manufacturer,Name,CurrentClockSpeed,MaxClockSpeed,NumberOfCores
}

function get-mydisks {
    Get-Disk | Sort-Object Number | format-table Manufacturer,Model,SerialNumber,FirmwareVersion,Size
}


Export-ModuleMember -Function ComputerSystem,OperatingSystem,ProcessorInfo,PhysicalMemory,DiskDriveInformation,AdapterSpecs,VideoController,welcome,get-cpuinfo,get-mydisks
